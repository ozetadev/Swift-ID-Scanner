...
class CameraViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    private func createMetadataObjectOverlayWithMetadataObject(_ metadataObject: AVMetadataObject) -> MetadataObjectLayer? {
        ...
        guard let barcodeMetadataObject = transformedMetadataObject as? AVMetadataMachineReadableCodeObject, barcodeMetadataObject.descriptor is CIPDF417CodeDescriptor else {
            return nil
        }
        ...
        if metadataObjectsOverlayLayersDrawingSemaphore.wait(timeout: .now()) == .success {
            DispatchQueue.main.async {
                ...
                for metadataObject in metadataObjects {
                    ...
                    guard let metadataObjectOverlayLayer = self.createMetadataObjectOverlayWithMetadataObject(metadataObject) else {
                        continue
                    }
